    ...
    <DragDropContext onDragEnd={onDragEndHandler}>
      ...
      <div className="z-10 container mx-auto p-2">
        ...
        <div
          ...
          } relative max-w-[500px] z-20 my-5 h-[50px] mx-auto rounded overflow-hidden border`}
        >
          <form onSubmit={onAddNewTodo} className="h-full w-full">
            <input
              className={`${
                error && "text-red-500 placeholder-red-500"
              } outline-none px-4 py-6 block h-full w-full`}
              type="text"
              placeholder={`${
            ...
            <button
              ...
              className={`${
                error && "bg-red-500"
              } z-30 absolute top-[50%] translate-y-[-50%] right-[1px] h-[45px] w-[45px] rounded bg-black text-white`}
            >
              NEW
            </button>
          </form>
